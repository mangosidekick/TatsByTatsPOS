    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            if (id == R.id.nav_home) {
                ...
                startActivity(new Intent(Inventory.this, SettingsActivity.class));
            } else if (id == R.id.nav_user_management) {
                startActivity(new Intent(Inventory.this, UserManagementActivity.class));
            }
    ...
    private void showEditProductDialog(Product product) {
        ...
        AlertDialog dialog = new AlertDialog.Builder(this, R.style.MyDialogTheme)
                ...
                .setPositiveButton("Update", (d, which) -> {
                    ...
                    boolean success = db.updateProduct(product.getId(), name, price, quantity, imageBytes, true);
                    if (success) {
